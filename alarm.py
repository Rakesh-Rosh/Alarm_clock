...
head =Label(root,text="ALARM CLOCK",font=('comic sans',20), fg="cyan", bg="Black")
head.pack(fill=X)
...
start = Button(panel,text="Start alarm",font=('comic sans',20),fg="cyan",bg="black",command=th)
